...
fun AdditionalText(
    ...
    AnimatedContent(
        ...
        transitionSpec = {
            slideIntoContainer(AnimatedContentTransitionScope.SlideDirection.Down, tween(200)) + fadeIn(tween(100)) togetherWith
            slideOutOfContainer(AnimatedContentTransitionScope.SlideDirection.Down, tween(200)) + fadeOut(tween(100))
        },
        label = ""
    ){ _ ->
        Text(
